...
<?php
  $sql = "SELECT * FROM guide WHERE post_category = 'Season'";
  $query = $conn->query($sql);

  if (isset($_POST['subcategory']))
  {
    $subcategory = $_POST["subcategory"];
    $sql = "SELECT * FROM guide WHERE post_category = 'Season' AND subcategory LIKE '%$subcategory%' ";
    $query = $conn->query($sql);
  }
  ...
  <div class="col-md-2" style="">
      <div class="" style="box-shadow: 0 0 2px rgb(0,0,0,0.3);">
        ...
        <div class="card-body">
          <form method="post">
          <div class="card-text">
            <a href="" class="btn btn-default">All Seasons</a>
          </div>
          <div class="card-text">
            <input type="submit" name="subcategory" class="btn btn-default" value="Summer">
          </div>
          <div class="card-text">
            <input type="submit" name="subcategory" class="btn btn-default" value="Rainy Season">
          </div>
          <div class="card-text">
            <input type="submit" name="subcategory" class="btn btn-default" value="Autumn">
          </div>
          <div class="card-text">
            <input type="submit" name="subcategory" class="btn btn-default" value="Late Autumn">
          </div>
          <div class="card-text">
            <input type="submit" name="subcategory" class="btn btn-default" value="Winter">
          </div>
          <div class="card-text">
            <input type="submit" name="subcategory" class="btn btn-default" value="Spring">
          </div>
        </form>
        </div>
      </div>
    ...
    <div class="card-header">Seasonal Guides</div>
    <div class="card-body">
      <?php 
