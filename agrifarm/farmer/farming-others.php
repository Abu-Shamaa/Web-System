...
<?php
  $sql = "SELECT * FROM guide WHERE post_category = 'Farming Others'";
  $query = $conn->query($sql);
?>

<div class="container" style="min-height: 80vh;padding: 30px;">
<div class="row">
  <?php
  ...
  ?>
    ...
    <div class="col-md-12" style="padding: 20px;box-shadow: 0 0 10px rgb(0,0,0,0.3);">
    <div class="card-header">Farming Guide For Other Types</div>
    <div class="card-body">
      <?php 
