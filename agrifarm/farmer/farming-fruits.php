...
<?php
  $sql = "SELECT * FROM guide WHERE post_category = 'Farming Fruits'";
  $query = $conn->query($sql);

  if (isset($_POST['subcategory']))
  {
    $subcategory = $_POST["subcategory"];
    $sql = "SELECT * FROM guide WHERE post_category = 'Farming Fruits' AND subcategory LIKE '%$subcategory%' ";
    $query = $conn->query($sql);
  }
...
<div class="row">
  ...
  <div class="col-md-2" style="">
      <div class="" style="box-shadow: 0 0 2px rgb(0,0,0,0.3);">
        <div class="card-header">Fruits Type</div>
        <div class="card-body">
          <form method="post">
          <div class="card-text">
            <a href="" class="btn btn-default">All Fruits</a>
          </div>
          <div class="card-text">
            <input type="submit" name="subcategory" class="btn btn-default" value="Apple">
          </div>
          <div class="card-text">
            <input type="submit" name="subcategory" class="btn btn-default" value="Orange">
          </div>
          <div class="card-text">
            <input type="submit" name="subcategory" class="btn btn-default" value="Watermelon">
          </div>
          <div class="card-text">
            <input type="submit" name="subcategory" class="btn btn-default" value="Grape">
          </div>
          <div class="card-text">
            <input type="submit" name="subcategory" class="btn btn-default" value="Strawberry">
          </div>
          <div class="card-text">
            <input type="submit" name="subcategory" class="btn btn-default" value="Blueberry">
          </div>
          <div class="card-text">
            <input type="submit" name="subcategory" class="btn btn-default" value="Honeydew">
          </div>
          <div class="card-text">
            <input type="submit" name="subcategory" class="btn btn-default" value="Carrot">
          </div>
          <div class="card-text">
            <input type="submit" name="subcategory" class="btn btn-default" value="Lemon">
          </div>
          <div class="card-text">
            <input type="submit" name="subcategory" class="btn btn-default" value="Mangoe">
          </div>
          <div class="card-text">
            <input type="submit" name="subcategory" class="btn btn-default" value="Pineapple">
          </div>
          <div class="card-text">
            <input type="submit" name="subcategory" class="btn btn-default" value="Jackfruit">
          </div>
        </form>
        </div>
      </div>
    ...
    <div class="card-header">Farming Guide For Fruits</div>
    <div class="card-body">
      <?php 
