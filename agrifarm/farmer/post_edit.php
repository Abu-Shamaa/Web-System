...
<div class="container" style="padding: 30px;box-shadow: 0 0 10px rgb(0,0,0,0.3);">
  ...
  <div class="form-group">
      <a href="all-order.php" class="btn btn-info btn-small float-right" style="color: white;"><i class="fa fa-arrow-left"></i> Back</a>
  </div>
  <form class="form-group" action="edt_post.php" method="POST" enctype="multipart/form-data">
    <div class="row">
