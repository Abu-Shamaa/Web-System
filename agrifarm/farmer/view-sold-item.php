  ...
  ?>
    <div class="row">
      <div class="col col-md-12 form-group">
        <a href="sold-orders.php" class="btn btn-info btn-small float-right" style="color: white;"><i class="fa fa-arrow-left"></i> Back</a>
      </div>

      <div class="col col-md-6 form-group">
        <label for="title" class="text-muted"> Listing Status: &emsp;</label>
        <h3 class="badge badge-success"><i class="fa fa-check"></i> SOLD</h3>
        <hr>
      </div>
