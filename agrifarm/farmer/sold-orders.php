...
<br>
<?php
  $sql2 = "SELECT * FROM order_item WHERE seller_id = '".$_SESSION['user']."'  AND status = '2'";
...
<!-- Nav tabs -->
  <ul class="nav nav-tabs" role="tablist">
    ...
    <li class="nav-item">
      <a class="nav-link active" href="sold-orders.php" style="font-weight: bold;">Sold Items</a>
    </li>
  </ul>
        ...
        <table id="example2" class="table table-striped table-bordered" style="width:100%">
              ...
              <?php
                while ($row2 = $query2->fetch_assoc()) {
                  $s2 = "SELECT * FROM users WHERE id = '".$row2["buyer_id"]."' ";
                  $q2 = $conn->query($s2);
                  while ($r2 =  $q2->fetch_assoc()) {
                    $buyer1 = $r2["firstname"]. " ". $r2['lastname'];
                  }
                  ...
                  echo '
                      ...
                      <tr>
                        ...
                        <td class="text-center">
                          <a href="view-sold-item.php?id='.$row2["id"].'" title="View Post">
