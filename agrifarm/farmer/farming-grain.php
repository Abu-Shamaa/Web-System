...
<?php
  $sql = "SELECT * FROM guide WHERE post_category = 'Farming Grains'";
  $query = $conn->query($sql);

  if (isset($_POST['subcategory']))
  {
    $subcategory = $_POST["subcategory"];
    $sql = "SELECT * FROM guide WHERE post_category = 'Farming Grains' AND subcategory LIKE '%$subcategory%' ";
    $query = $conn->query($sql);
  }
...
<div class="row">
  ...
  <div class="col-md-2" style="">
      <div class="" style="box-shadow: 0 0 2px rgb(0,0,0,0.3);">
        <div class="card-header">Grains Type</div>
        <div class="card-body">
          <form method="post">
          <div class="card-text">
          ...
          <div class="card-text">
            <input type="submit" name="subcategory" class="btn btn-default" value="Rice">
          </div>
          <div class="card-text">
            <input type="submit" name="subcategory" class="btn btn-default" value="Corn">
          </div>
          <div class="card-text">
            <input type="submit" name="subcategory" class="btn btn-default" value="Oats">
          </div>
          <div class="card-text">
            <input type="submit" name="subcategory" class="btn btn-default" value="Barley">
          </div>
          <div class="card-text">
            <input type="submit" name="subcategory" class="btn btn-default" value="Wheat">
          </div>
          <div class="card-text">
            <input type="submit" name="subcategory" class="btn btn-default" value="Flour">
          </div>
          <div class="card-text">
            <input type="submit" name="subcategory" class="btn btn-default" value="Popcorn">
          </div>
          <div class="card-text">
            <input type="submit" name="subcategory" class="btn btn-default" value="Rye">
          </div>
          <div class="card-text">
            <input type="submit" name="subcategory" class="btn btn-default" value="Millet">
          </div>
          <div class="card-text">
            <input type="submit" name="subcategory" class="btn btn-default" value="Amaranth">
          </div>
    ...
    <div class="card-header">Farming Guide For Grains</div>
    <div class="card-body">
      <?php 
