  ...
  <div class="row">
          ...
          <div class="col col-md-12 form-group">
            ...
            <form action ="update_profile.php" method="post" id="image-form" enctype="multipart/form-data">
              ...
              <center class="form-group">
                <input type="file" name="photo" class="file" accept="image/*" style="visibility: hidden;" value="<?php echo $user['profile_pic']; ?>">
              ...
              <center class="form-group">
                <button type="submit" name="admin_profilepic" class="btn btn-info"><i class="fa fa-check"></i> Save Profile Photo</button>
              </center>
            </form>
    ...
    <div class="col-md-7" style="padding: 20px;box-shadow: 0 0 10px rgb(0,0,0,0.3);">
      <form method="POST" action="update_profile.php" style="max-width: 800px;">
        ...
        <div class="col col-md-12 form-group">
          <button type="submit" name="admin_info" class="btn btn-info"><i class="fa fa-check"></i> Save Info</button>
        </div>
