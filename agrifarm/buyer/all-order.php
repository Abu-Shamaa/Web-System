...
<br>
<?php
  $sql1 = "SELECT * FROM order_item WHERE buyer_id = '".$_SESSION['user']."' AND status = 1";
...
<!-- Nav tabs -->
  <ul class="nav nav-tabs" role="tablist">
    <li class="nav-item">
      <a class="nav-link active" href="all-order.php" style="font-weight: bold;">New Orders</a>
    </li>
    <li class="nav-item">
      <a class="nav-link" href="delivered-orders.php" style="font-weight: bold;">Delievered orders</a>
    </li>
  </ul>
                  ...
                  echo '
                      <tr>
                        ...
                        <td class="text-center">
                          <a href="view-order.php?id='.$row1["id"].'" title="View Post">
